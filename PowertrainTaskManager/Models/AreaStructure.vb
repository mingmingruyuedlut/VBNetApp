...
Namespace Models
    Public Class AreaStructure
        ...
        Public Property MemberAffiliation As String
        Public Property Version As String
        Public Sub New(ByVal id As Integer, ByVal parent As String, ByVal memberName As String, ByVal memberType As String, ByVal memberOrder As String, ByVal memberDescription1 As String, ByVal memberDescription2 As String, ByVal memberDescription3 As String, ByVal memberValues As String, ByVal taskXrefName As String, ByVal visible As Integer, ByVal global1 As Integer, ByVal base As Integer, ByVal maxLength As Integer, ByVal minValue As Integer, ByVal maxValue As Integer, ByVal exclusionString As String, ByVal memberAffiliation As String, ByVal version As String)
            Me.Id = id
            Me.Parent = parent
            ...
            Me.Version = version
            Me.MemberAffiliation = memberAffiliation
        End Sub
        Public Sub New()
